...
def test_notifications_create_list_mark_read_flow():
    with httpx.Client(timeout=10) as client:
        ...
        inbox = _request(
            ...
            "GET",
            "/notifications",
            params={"recipient_user_id": 1, "unread_only": True},
        )
        ...
        assert created_row["sender_user_id"] == 2
        ...
        assert marked["payload"]["recipient_user_id"] == 1
