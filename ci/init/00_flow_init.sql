...
CREATE INDEX idx_distribution_list_content_user ON ref.distribution_list_content(user_id);
...
CREATE TABLE notification_targets (
    ...
    recipient_dist_id SMALLINT REFERENCES ref.distribution_list(dist_id),
