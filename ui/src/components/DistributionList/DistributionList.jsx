...
const DistributionList = ({ docId, apiBase, onClose }) => {
  ...
  return (
    <div className="distribution-list-container">
      ...
      <div className="distribution-list-header">
        ...
        <div className="button-group">
          ...
          <button
            ...
            disabled={loading || !selectedPerson}
            title="Send document to recipients"
          >
            Send
          </button>
        </div>
      ...
      {isCreating && (
        <div className="add-recipients-section">
          ...
          <div className="recipients-list">
            {lists.map((list) => (
              <div
                ...
                className={`recipient-item ${selectedPerson === String(list.dist_list_id) ? "selected" : ""} ${sentLists.has(list.dist_list_id) ? "sent" : ""}`}
                onClick={() => setSelectedPerson(String(list.dist_list_id))}
              >
